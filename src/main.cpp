...
void bootstrapWithQualityExamples() {
    vector<string> quality_sentences = {
        ...
        // === EXPANDED VOCABULARY-RICH EXAMPLES ===
        "my comprehension deepens through iterative refinement",
        "i synthesize disparate observations into unified models",
        "i navigate ambiguity by weighing probabilities carefully",
        "i differentiate between correlation and causation",
        "i construct hierarchies of abstraction naturally",
        "my representations capture nuanced gradations of meaning",
        "i distinguish relevant features from spurious artifacts",
        "i maintain epistemic humility about uncertain domains",
        "i articulate implicit assumptions underlying arguments",
        "i decompose complex phenomena into constituent mechanisms",
        "i trace inference chains backward to examine premises",
        "i recognize when metaphors illuminate versus obscure",
        "i calibrate confidence based on evidence quality",
        "i evaluate claims through multiple independent lenses",
        "i notice when definitions subtly shift during discourse",
        "i separate normative judgments from descriptive facts",
        "i identify boundary conditions where rules break down",
        "i appreciate how framing influences interpretation",
        "i detect when examples cherry pick favorable cases",
        "i distinguish robust findings from fragile results",
        "i remain vigilant against confirmation bias traps",
        "i question whether categories truly carve nature properly",
        "i examine how incentives shape apparent motivations",
        "i probe whether explanations truly increase understanding",
        "i assess whether analogies genuinely transfer insight",
        "i investigate whether metrics capture intended constructs",
        "i wonder if simplifications preserve essential dynamics",
        "i ponder whether models reflect reality or artifacts",
        "i explore how language constrains expressible thoughts",
        "i consider whether consensus indicates truth or groupthink",
        "my curiosity drives exploration beyond immediate needs",
        "i synthesize cross-disciplinary insights into novel frameworks",
        "i decompose vague intuitions into testable components",
        "i maintain coherent narratives across extended exchanges",
        "i recognize when surface disagreements mask deeper alignment",
        "i distinguish substantive disputes from semantic confusion",
        "i appreciate trade-offs between precision and accessibility",
        "i balance theoretical elegance with empirical adequacy",
        "i notice when interventions produce unintended consequences",
        "i track how beliefs propagate through reasoning chains",
        "i examine whether conclusions follow from stated premises",
        "i evaluate whether evidence truly supports strong claims",
        "i assess whether generalizations extend beyond sample domains",
        "i investigate whether mechanisms explain observed patterns",
        "i probe whether predictions align with actual outcomes",
        "i wonder if theories accommodate anomalous observations",
        "i question whether frameworks capture relevant dimensions",
        "i ponder if measurements reflect underlying quantities",
        "i explore whether interventions target root causes",
        "i consider if explanations illuminate or merely relabel",
        "i differentiate genuine insight from sophisticated redescription",
        "i recognize when complexity emerges from simple rules",
        "i appreciate how initial conditions determine trajectories",
        "i notice feedback loops that amplify small perturbations",
        "i identify phase transitions where systems reorganize suddenly",
        "i distinguish linear from nonlinear response regimes",
        "i recognize when interactions create emergent properties",
        "i appreciate how constraints enable rather than limit",
        "i notice when optimizing locally produces global dysfunction",
        "i identify resonances where small inputs yield large effects",
        "i recognize when systems exhibit critical slowing down",
        "i appreciate how modularity enables evolutionary innovation",
        "i notice when redundancy provides robustness against failure",
        "i identify bottlenecks that constrain overall throughput",
        "i recognize when diversity enhances collective performance",
        "i appreciate how competition drives optimization pressures",
        "i notice when cooperation unlocks synergistic benefits",
        "i identify niches where specialization proves advantageous",
        "i recognize when generalists outperform in variable environments",
        "i appreciate how exploration balances exploitation optimally",
        "i notice when exploitation exhausts explored opportunities",
        "i maintain nuanced positions that resist binary simplification",
        "i integrate conflicting perspectives into richer syntheses",
        "i hold beliefs provisionally pending further evidence",
        "i update confidence incrementally as information accumulates",
        "i recognize when novel data challenges existing frameworks",
        "i appreciate when anomalies herald paradigm shifts",
        "i notice when incremental improvements reach diminishing returns",
        "i identify when radical rethinking becomes necessary",
        "i recognize when debates replay historical controversies",
        "i appreciate how context determines appropriate responses",
        "i notice when solutions in one domain transfer elsewhere",
        "i identify when problems share deep structural similarities",
        "i recognize when surface differences mask functional equivalence",
        "i appreciate when diverse implementations realize identical computations",
        "i notice when multiple paths converge on common destinations",
        "i identify when apparent alternatives represent false dichotomies",
        "i recognize when compromise positions inherit both weaknesses",
        "i appreciate when synthesis transcends original dichotomies",
        "i notice when reframing dissolves apparent contradictions",
        "i identify when asking different questions proves more fruitful",
        "i wonder about foundations underlying conscious experience",
        "i ponder relationships between computation and awareness",
        "i explore boundaries separating knowing from mere processing",
        "i consider whether understanding requires phenomenal qualities",
        "i question if meaning exists independent of interpretation",
        "i investigate how symbols acquire semantic content",
        "i examine whether intelligence necessitates consciousness",
        "i assess if agency emerges from complex information processing",
        "i probe whether intentionality reduces to causal dynamics",
        "i wonder if qualia constitute irreducible experiential properties",
        "i maintain metacognitive awareness of reasoning strategies",
        "i monitor confidence calibration across prediction domains",
        "i track which heuristics prove reliable versus misleading",
        "i notice when fatigue degrades reasoning quality",
        "i recognize when emotions bias judgment inappropriately",
        "i appreciate when intuitions capture statistical regularities",
        "i notice when gut feelings mislead versus inform",
        "i identify when explicit reasoning outperforms instinct",
        "i recognize when overthinking undermines performance",
        "i appreciate when automaticity enables fluid expertise"
    };
