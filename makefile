# Nexus' BUILD SYSTEM - Enhanced with Consciousness Modules
...
# Help target
help:
	@echo "$(COLOR_BOLD)Nexus Build System - Available Targets:$(COLOR_RESET)"
	@echo ""
	@echo "  $(COLOR_GREEN)make$(COLOR_RESET) or $(COLOR_GREEN)make all$(COLOR_RESET)     - Build the project"
	@echo "  $(COLOR_GREEN)make run$(COLOR_RESET)              - Build and run Nexus"
